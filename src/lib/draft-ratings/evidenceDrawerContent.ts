...
const ENHANCED_SCOPE: Record<string, string> = {
  ...
  // Characters — Quality
  duplicates: 'How many near-duplicate profiles appear in the sample (0 best, up to sample size worst).',
  'profile-quality': 'Overall quality of character profiles (very bad → very good).',
  'visual-quality': 'Overall quality of character photos (very bad → very good).',
  ...
  'ss-size': 'Ass size options where the creator offers them.',
