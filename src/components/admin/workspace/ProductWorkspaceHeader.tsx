...
export function ProductWorkspaceHeader() {
  ...
  return (
    <div
      className="sticky top-0 z-20 -mx-4 border-b border-slate-200 bg-slate-100/95 px-4 backdrop-blur dark:border-slate-800 dark:bg-slate-950/95 md:-mx-6 md:px-6 [--workspace-sticky-top:6.5rem]"
    >
